...
#
# Created: Sat Nov 19 18:03:24 2022
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.swift_sail = QtWidgets.QRadioButton(self.tab)
        self.swift_sail.setChecked(True)
        self.swift_sail.setObjectName("swift_sail")
        self.gridLayout.addWidget(self.swift_sail, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.increase_player_movement_speeds, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.increase_grapple_animation_speed, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.increase_block_moving_animation, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.increase_misc_animations, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.tingle_chests_without_tuner, 14, 0, 1, 1)
        self.invert_camera_x_axis = QtWidgets.QCheckBox(self.tab)
        self.invert_camera_x_axis.setChecked(False)
        self.invert_camera_x_axis.setObjectName("invert_camera_x_axis")
        self.gridLayout.addWidget(self.invert_camera_x_axis, 19, 0, 1, 1)
        self.reveal_full_sea_chart = QtWidgets.QCheckBox(self.tab)
        self.reveal_full_sea_chart.setChecked(False)
        self.reveal_full_sea_chart.setObjectName("reveal_full_sea_chart")
        self.gridLayout.addWidget(self.reveal_full_sea_chart, 21, 0, 1, 1)
        self.KORL_control = QtWidgets.QCheckBox(self.tab)
        self.KORL_control.setChecked(False)
        self.KORL_control.setObjectName("KORL_control")
        self.gridLayout.addWidget(self.KORL_control, 20, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ballad, 16, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.instant_text_boxes, 8, 0, 1, 1)
        self.memorylogo = QtWidgets.QCheckBox(self.tab)
        self.memorylogo.setChecked(True)
        self.memorylogo.setObjectName("memorylogo")
        self.gridLayout.addWidget(self.memorylogo, 24, 0, 1, 1)
        self.titlelogo = QtWidgets.QCheckBox(self.tab)
        self.titlelogo.setChecked(False)
        self.titlelogo.setObjectName("titlelogo")
        self.gridLayout.addWidget(self.titlelogo, 23, 0, 1, 1)
        self.brisk_sail = QtWidgets.QRadioButton(self.tab)
        self.brisk_sail.setChecked(False)
        self.brisk_sail.setObjectName("brisk_sail")
        self.gridLayout.addWidget(self.brisk_sail, 7, 0, 1, 1)
        self.brisk_sail2 = QtWidgets.QRadioButton(self.tab)
        self.brisk_sail2.setChecked(False)
        self.brisk_sail2.setObjectName("brisk_sail2")
        self.gridLayout.addWidget(self.brisk_sail2, 7, 1, 1, 1)
        self.normal_sail = QtWidgets.QRadioButton(self.tab)
        self.normal_sail.setChecked(False)
        self.normal_sail.setObjectName("normal_sail")
        self.gridLayout.addWidget(self.normal_sail, 5, 0, 1, 1)
        self.normal_sail2 = QtWidgets.QRadioButton(self.tab)
        self.normal_sail2.setChecked(False)
        self.normal_sail2.setObjectName("normal_sail2")
        self.gridLayout.addWidget(self.normal_sail2, 5, 1, 1, 1)
        self.randomize_enemy_palettes = QtWidgets.QCheckBox(self.tab)
        self.randomize_enemy_palettes.setChecked(False)
        self.randomize_enemy_palettes.setObjectName("randomize_enemy_palettes")
        self.gridLayout.addWidget(self.randomize_enemy_palettes, 22, 0, 1, 1)
        self.swift_sail2 = QtWidgets.QRadioButton(self.tab)
        self.swift_sail2.setChecked(False)
        self.swift_sail2.setObjectName("swift_sail2")
        self.gridLayout.addWidget(self.swift_sail2, 6, 1, 1, 1)
        self.label_81 = QtWidgets.QLabel(self.tab)
        self.label_81.setText("")
        self.label_81.setObjectName("label_81")
        self.gridLayout.addWidget(self.label_81, 25, 0, 1, 1)
        ...
        self.disable_custom_player_items = QtWidgets.QCheckBox(self.tab_2)
        ...
        self.option_description.setMinimumSize(QtCore.QSize(0, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.KORL_control.setText(QtWidgets.QApplication.translate("MainWindow", "Unrestricted boat", None, -1))
        ...
        self.normal_sail.setText(QtWidgets.QApplication.translate("MainWindow", "Normal sail", None, -1))
        self.normal_sail2.setText(QtWidgets.QApplication.translate("MainWindow", "Normal sail controls wind", None, -1))
        self.randomize_enemy_palettes.setText(QtWidgets.QApplication.translate("MainWindow", "Random enemy colors", None, -1))
        ...
        self.player_in_casual_clothes.setText(QtWidgets.QApplication.translate("MainWindow", "Second quest", None, -1))
        self.disable_custom_player_voice.setText(QtWidgets.QApplication.translate("MainWindow", "Disable custom voice", None, -1))
        self.disable_custom_player_items.setText(QtWidgets.QApplication.translate("MainWindow", "Disable custom items", None, -1))
